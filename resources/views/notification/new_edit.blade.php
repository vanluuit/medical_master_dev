              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('category_id', $cate, $message->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2 change_new_sl filter_in', 'id'=>'category_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('category_new_id', $cate_new, $message->category_new_id, ['placeholder' => 'category new', 'class'=>'form-control select2 change_new_sl', 'id'=>'category_new_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('new_id', $news, $message->new_id, ['placeholder' => ' new', 'class'=>'form-control select2', 'id'=>'new_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-3">
