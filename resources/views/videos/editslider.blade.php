    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => ['videos.update', $video->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                @method('PUT')
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('channel_id', $channels, $video->channel_id, ['placeholder' => 'チャンネル', 'class'=>'form-control select2','id'=>'change_channel']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
