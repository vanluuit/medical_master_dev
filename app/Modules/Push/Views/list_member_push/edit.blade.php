...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                {!! Form::open(array('route' => ['push.listmemberpushs.edit', $list->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                  <div class="form-group row">
                    <div class="col-md-12">
                      {!! Form::text('name', $list->name, ['placeholder' => '新規リストタイトル', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
