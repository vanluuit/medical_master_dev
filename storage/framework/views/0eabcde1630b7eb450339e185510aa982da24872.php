        ...
        <div class="col-md-12">
            <div class="card">
              <div class="border-bottom">
                <div class="card-body">
                  <h5 class="card-title">pdf add</h5>
                </div>
              </div>
              <div class="card-body">
                <?php echo Form::open(array('route' => 'videos.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                       ...
                       <?php echo Form::select('channel_id', $channels, '', ['placeholder' => 'チャンネル', 'class'=>'form-control select2','id'=>'change_channel']); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="file" style="width: 0; height: 0; line-height: 0; margin: 0; padding: 0"  name="pdf" id="pdf" data-text="pdf_text" class="form-control" placeholder="pdf" accept="application/pdf">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-3">
                      ...
                      <?php echo Form::text('ads_text', '', ['placeholder' => 'ads text', 'class'=>'form-control']); ?>
                  ...
                  <div class="form-group row"> -->
                    ...
                    <div class="col-md-3">
                      ...
                      <?php echo Form::text('ads_url', '', ['placeholder' => 'ads url', 'class'=>'form-control']); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-3">
                      ...
                      <?php echo Form::text('ads_text_2', '', ['placeholder' => 'ads text 2', 'class'=>'form-control']); ?>
                  ...
                  <div class="form-group row"> -->
                    ...
                    <div class="col-md-3">
                      ...
                      <?php echo Form::text('ads_url_2', '', ['placeholder' => 'ads url 2', 'class'=>'form-control']); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      ...
                      <?php echo Form::text('sponser', '', ['placeholder' => 'スポンサー', 'class'=>'form-control']); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                       ...
                       <?php echo Form::select('related[]', [], '', ['class'=>'form-control  select2-video-mutil', 'multiple'=>'multiple', 'id'=>'select2-video-mutil']); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <?php echo Form::text('url', '', ['placeholder' => 'Url', 'class'=>'form-control']); ?>
