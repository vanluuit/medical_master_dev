            ...
            <div class="card-body">
                ...
                <div class="row">
	                <div class="col-md-6">
	                  ...
	                  <div class="form-group row">
	                    <div class="col-md-12">
	                       {!! Form::text('typex', 'Quick', ['placeholder' => 'タイトル', 'class'=>'form-control', 'readonly'=>'true']) !!}
	                       <input type="hidden" name="type" value="1">
	                      <!--  {!! Form::select('type', [1=>'Quick',2=>'TVpro',3=>'News',4=>'Mypage', '5'=>'Seminar'], $message->type, ['placeholder' => 'リンク先画面選択', 'class'=>'form-control select2']) !!} -->
	                    </div>
	                  </div>
	                  <!-- <div class="form-group row">
	                    <div class="col-md-4">
