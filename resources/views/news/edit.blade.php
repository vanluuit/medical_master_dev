    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => ['news.update', $News->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                @method('PUT')
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_id', $cate, $News->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_new_id', $categories, $News->category_new_id, ['placeholder' => 'カテゴリー', 'class'=>'form-control association_select']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('title', $News->title, ['placeholder' => 'タイトル', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <div class="thumbnail">
                        <img id="media_show" src="{{$News->media}}" alt="" />
                      </div> 
                    </div>
                  </div>
                  <!-- <div class="form-group row">
                    <div class="col-md-12">
                      <div class="custom-control custom-checkbox mr-sm-2">
                          <input type="checkbox" class="custom-control-input" value="1" name="publish" id="shownews" @if( $News->publish == 1 ) checked @endif >
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('url', $News->url, ['placeholder' => 'url', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('copyright', $News->copyright, ['placeholder' => 'copyright', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group date">
                        <input type="text" name="date" class="form-control datetimepicker" id="datetimepicker" placeholder="日付を公開" value="{{$News->date}}">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <textarea class="form-control CKEDITOR" id="my-editor" name="content">{{$News->content}}</textarea>
                    </div>
                  </div>
                </div>
