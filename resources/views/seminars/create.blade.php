    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => 'seminars.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('website', '', ['placeholder' => 'website', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-3">
              ...
              <table  style="display: none">
                ...
                <tr>
                  <td>__time__</td>
                  <td>
                      {!! Form::select('time[__time__][start_time]', timeSelect(), '', [ 'class'=>'form-control']) !!}
                  </td>
                  <td>
                    {!! Form::select('time[__time__][end_time]', timeSelect(), '23:00', [ 'class'=>'form-control']) !!}
                  </td>
                </tr>
                </tbody>
              </table>
