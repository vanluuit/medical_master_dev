    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => ['prs.update', $pr->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                @method('PUT')
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_id', $categories, $pr->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2','id'=>'change_association']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('video_id', $videos, $pr->video_id, ['placeholder' => 'video', 'class'=>'form-control select2', 'id'=>'video_id_sl']) !!}
                    </div>
                  </div> 
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('title', $pr->title, ['placeholder' => 'title', 'class'=>'form-control']) !!} 
                    </div>
                  </div> 
                </div>
