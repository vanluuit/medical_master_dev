    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => 'newbanners.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                       <?php echo Form::select('type', ['1'=>'Content', '2'=>'Url'], '', ['placeholder' => 'type', 'class'=>'form-control select2', 'id'=>'change_association_type']); ?>

                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                       <?php echo Form::select('category_id', $categories, '', ['placeholder' => '学会選択', 'class'=>'form-control select2', 'id'=>'change_association']); ?>

                    </div>
                  </div>
                  
                  <div class="form-group row" style="display:none" id="type_1">
                    <div class="col-md-6">
                       <?php echo Form::select('video_id', [], '', ['placeholder' => 'video', 'class'=>'form-control select2', 'id'=>'video_id_sl']); ?>

                    </div>
                  </div> 
                  <div class="url-div"  style="display:none" id="type_2">
                    <div class="form-group row">
                      <div class="col-md-6">
                  ...
                  <!-- <div class="form-group row">
                    <div class="col-md-6">
                       <?php echo Form::select('location', $location_ar, '', ['placeholder' => 'location', 'class'=>'form-control select2']); ?>
