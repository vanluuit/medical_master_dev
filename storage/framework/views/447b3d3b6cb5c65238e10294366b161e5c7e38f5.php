    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => 'channels.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>

                  <div class="form-group row">
                    <div class="col-md-6">
                       <?php echo Form::select('category_id[]', $categories, '', ['class'=>'form-control select2-cate-mutil', 'multiple'=>'multiple']); ?>
