...
public function api_list_by_top(Request $request)
    ...
    public function edit($id)
    {
        ...
        return view('channels.edit', compact('categories','channel'));
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        return redirect(route('channels.index').'?category_id='.$request->category_id);
    }
    ...
    public function listByCategory(Request $request){
        ...
        if($request->category_id) {
            $channel = $channel->whereHas('association', function($qr)use($request){
