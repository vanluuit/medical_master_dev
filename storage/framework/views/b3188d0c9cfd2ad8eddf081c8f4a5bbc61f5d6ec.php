    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark">
                <div id="loginform" class="border-top border-secondary">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo e(URL::asset('/assets/images/logo.png')); ?>" alt="logo" /></span>
                        <span class="te">Medical Push</span>
                    </div>
                    <!-- Form -->
                    <?php echo Form::open(array('route' => 'push.doLogin')); ?>
