...
<div class="container-fluid">
    ...
    <div class="card">
    {!! Form::open(array('route' => ['push.notification.update', $message->id], 'id'=>'form_ajax', 'enctype'=>'multipart/form-data')) !!}
    @method('PUT')
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <textarea class="form-control" name="message" cols="30" rows="10" placeholder="本文">{{$message->message}}</textarea>
              </div>
            </div>  
            <div class="form-group row">
              <div class="col-md-12">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                 {!! Form::select('channel_id', $channel, $message->channel_id, ['placeholder' => 'チャンネル選択', 'class'=>'form-control select2', 'id'=>'channel_id']) !!}
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                 {!! Form::select('content_id', $videos,  $message->content_id, ['placeholder' => 'リンク先コンテンツ', 'class'=>'form-control select2', 'id'=>'content_id']) !!}
              </div>
            </div>
<!--             <div class="form-group row">
                      <div class="col-md-4">
