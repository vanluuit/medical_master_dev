    ...
    <div class="scrollable-content scrollable-slim-sidebar">
        <div class="pad10A">
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial1.jpg" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial2.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>Carl Gamble </b>
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial3.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>Michael Poole</b>
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial4.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>Bill Green</b>
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial5.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>Cheryl Soucy </b>
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial6.jpg" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial7.jpg" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>Dan Garcia</b>
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="./images/testimonial8.jpg" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b> Edward Bridges</b>
