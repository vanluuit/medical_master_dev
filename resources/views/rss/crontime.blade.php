    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => ['rss.postcrontime'], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                <div class="form-group row">
                    <div class="col-md-3">
                      {!! Form::select('time', $time, $crontime->time, ['class'=>'form-control']) !!}
                    </div>
                    <div class="col-md-3">
                      {!! Form::select('minute', $minute, $crontime->minute, ['class'=>'form-control']) !!}
                    </div>
                  </div>
                </div>
