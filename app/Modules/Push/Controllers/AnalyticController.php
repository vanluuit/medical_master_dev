...
class AnalyticController extends Controller
{
    ...
    public function channels(Request $request)
    {
        ...
        return view('Push::analytic.channel', compact(['channels']));
    }
    ...
    //     // dd($contents);
    //     return view('Push::analytic.content', compact(['contents']));
    // }
    ...
    public function content(Request $request)
    {
        ...
        // dd($contents);
        return view('Push::analytic.content', compact(['contents','start_day','end_day']));
    }
    /**
    ...
    public function contentDetail(Request $request, $id)
    {
        ...
        $viewlists = ViewVideo::select(DB::raw('COUNT(DISTINCT (case when status = 1 then user_id end)) as comp_u,COUNT(DISTINCT (case when status = 0 then user_id end)) as withx_u, COUNT(IF(status=1, 1 , NULL)) as comp ,COUNT(IF(status=0, 1 , NULL)) as withx ,COUNT(*) as total, SUM(time_view) as total_time ,DATE_FORMAT(created_at, "%Y-%m-%d") as day_list'))
            ...
            ->get();
        // dd($time_total);
        return view('Push::analytic.contentDetail', compact(['contents','viewlists','id','time_total','start_day', 'end_day']));
    }
    ...
    public function contentDetailDay(Request $request, $id, $day)
    {
        ...
        return view('Push::analytic.contentDetailDay', compact(['contents','data_days','id','time_total','start_day', 'end_day']));
    }
    ...
    public function contentDetailDayTime(Request $request, $id, $day, $time)
    {
        ...
        $datas = ViewVideo::with(['user'])->where('created_at', '>', $start_day)
            ...
            ->get();
        // dd($datas);
        return view('Push::analytic.contentDetailDayTime', compact(['contents','datas','id','start_day', 'end_day']));
    }
    ...
    public function contentDetailUser(Request $request, $id)
    {
        ...
        $user_vs = ViewVideo::with(['user'])
            ...
            ->get();
            // dd($user_vs);   
        return view('Push::analytic.contentDetailUser', compact(['user_vs','contents','start_day', 'end_day']));
    }
    ...
    public function contentDetailUserHistory(Request $request, $id)
    {
        ...
        ->where('video_id', $id)
        ->groupBy('user_id')->get();
        return view('Push::analytic.contentDetailUserHistory', compact(['viewlists','contents']));
        // dd($viewlists);
    }
    ...
    public function contentDetailAccessHistory(Request $request, $id)
    {
        ...
        ->where('created_at', '<=', $end_day.' 23:59:59')
        ->paginate(50);
        return view('Push::analytic.contentDetailAccessHistory', compact(['viewlists','contents']));
        // dd($viewlists);
    }
    ...
    public function news(Request $request)
    {
        ...
        return view('Push::analytic.news', compact(['news', 'start_day', 'end_day']));
    }
    ...
    public function newsAccess(Request $request, $id)
    {
        ...
        ->where('created_at', '<=', $end_day.' 23:59:59')
        ->paginate(50);
        return view('Push::analytic.newsAccess', compact(['viewlists','new']));
        // dd($viewlists);
    }
    ...
    public function Ranking(Request $request)
    {
        ...
        return view('Push::analytic.ranking', compact(['rankings','start_day','end_day']));
    }
    ...
    public function analyticBanner(Request $request)
    {
        ...
        return view('Push::analytic.banner', compact(['categories']));
    }
    ...
    public function analyticBannerView($id)
    {
        ...
        return view('Push::analytic.bannerView', compact(['banners','start_day','end_day']));
    }
