                      ...
                      <tbody>
                        ...
                        @foreach($news as $key => $new)
                          <tr>
                            <td>{{$new->id}}</td>
                            <td>{{$new->title}}</td>
                            <td><a href="{{route('push.analytic.news.access', $new->id)}}?start_date={{$start_day}}&end_day={{$end_day}}">{{$new->count_view_count}}</a></td>
                            {{-- <td>{{$new->count_like_count}}</td> --}}
                            <td><a href="{{route('push.commentnews.index')}}?new_id={{$new->id}}&start_date={{$start_day}}&end_day={{$end_day}}">{{$new->count_comment_count}}</a></td>
                          </tr>
                        @endforeach
                        @endif
                      </tbody>
