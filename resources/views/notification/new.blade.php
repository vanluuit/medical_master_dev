...
<div class="container-fluid">
        <!-- Column -->
            ...
            <div class="card">
              {!! Form::open(array('route' => 'notification.store', 'id'=>'form_ajax', 'enctype'=>'multipart/form-data')) !!}
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('category_id', $cate, '', ['placeholder' => '学会選択', 'class'=>'form-control select2 change_new_sl filter_in', 'id'=>'category_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('category_new_id', $cate_new, '', ['placeholder' => 'category new', 'class'=>'form-control select2 change_new_sl', 'id'=>'category_new_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-12">
                         {!! Form::select('new_id', $news, '', ['placeholder' => ' new', 'class'=>'form-control select2', 'id'=>'new_id']) !!}
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-3">
...
@section('script') 
    <script>
        ...
        $(document).on('change','.change_new_sl', function(){
          ...
          $.ajax({url: "{{route('news.by.category')}}?category_id="+category_id+'&category_new_id='+category_new_id, success: function(result){
