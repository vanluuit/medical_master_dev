    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <?php echo Form::open(array('route' => ['pushusers.update', $user->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <input type="text" name="username" value="<?php echo e($user->username); ?>" class="form-control" placeholder="ユーザ名" readonly="">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-4">
                    <input type="text" name="password" id="password"  value="<?php echo e($user->password); ?>" class="form-control" placeholder="パスワード">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <?php echo Form::select('category_id', $categories, $user->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2']); ?>
