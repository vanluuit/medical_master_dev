...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center" style="display: block!important;">
            ...
            <a href="{{route('push.analytic.content')}}" class="btn btn-info btn-sm float-right">Content</a> 
        </div>
    </div>
</div>
...
<!--                             <td>
                              <a class="btn btn-cyan btn-sm" href="{{route('push.channels.edit',$channel->id)}}">Detail</a>
                            </td> -->
                          </tr>
                        @endforeach
                        @endif
