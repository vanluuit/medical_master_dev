        ...
        <div class="col-md-12">
            <div class="card">
              <div class="border-bottom">
                <div class="card-body">
                  <h5 class="card-title">channels add</h5>
                </div>
              </div>
              <div class="card-body">
                {!! Form::open(array('route' => 'channels.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_id[]', $categories, '', ['class'=>'form-control select2-cate-mutil', 'multiple'=>'multiple']) !!}
                    </div>
                  </div>
                 {{--  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_channel_id', $cates, '', ['placeholder' => 'カテゴリー', 'class'=>'form-control select2']) !!}
                    </div>
                  </div> --}}
                  <div class="form-group row">
                    <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group date">
                        <input type="text" name="publish_date" class="form-control datetimepicker" id="datetimepicker" placeholder="日付を公開">
