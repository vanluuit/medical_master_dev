...
class QuestionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Push::questions.index', compact(['questions']));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('Push::questions.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($rs) {
            ...
            return redirect(route('push.questions.index').'?video_id='.$request->video_id);
        }else{
            return back();
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('Push::questions.edit', compact(['question','answer']));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('push.questions.index').'?video_id='.$video_id);
    }
