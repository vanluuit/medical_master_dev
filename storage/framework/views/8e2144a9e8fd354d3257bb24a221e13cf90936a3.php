                ...
                <?php echo Form::open(array('route' => 'videos.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <input type="file" style="width: 0; height: 0; line-height: 0; margin: 0; padding: 0"  name="video_create" id="video" data-text="video_text" class="form-control" placeholder="video" accept="video/*">
