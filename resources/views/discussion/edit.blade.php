    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => ['discussion.update', $discussion->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                @method('PUT')
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_id', $categories, $discussion->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2']) !!}
                    </div>
                  </div>
                  <!-- <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('category_discussion_id', $cate, $discussion->category_discussion_id, ['placeholder' => 'カテゴリー', 'class'=>'form-control association_select']) !!}
                    </div>
                  </div> -->
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('title', $discussion->title, ['placeholder' => 'タイトル', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12">
                      <textarea class="form-control" name="discription" placeholder="discription" rows="6">{{$discussion->discription}}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <div class="thumbnail">
                        <img id="image1_show" src="{{URL::to('/')}}/{{$discussion->image1}}" alt="" />
                      </div> 
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <div class="thumbnail">
                        <img id="image2_show" src="{{URL::to('/')}}/{{$discussion->image2}}" alt="" />
                      </div> 
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <div class="thumbnail">
                        <img id="image3_show" src="{{URL::to('/')}}/{{$discussion->image3}}" alt="" />
                      </div> 
                    </div>
                  </div>
                </div>
