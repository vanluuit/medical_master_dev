                ...
                <table class="table">
                      ...
                      <tbody>
                        ...
                        @foreach($data_days as $key => $data_day)
                          <tr class="link_url" data-url="{{route('push.analytic.content.detail.day.time', [$id,$start_day,$data_day['time']])}}">
                           <td>{{$data_day['time']}}</td>
                           <td>{{$data_day['view']}}</td>
                           <td>
                            @if($data_day['view'])
                            <a class="btn btn-cyan btn-sm" href="{{route('push.analytic.content.detail.day.time', [$id,$start_day,$data_day['time']])}}">View</a>
                            @endif
                          </td>
                          </tr>
                        @endforeach
