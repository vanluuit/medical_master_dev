                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link waves-effect waves-light" style="font-size: 14px;">{{session('user')['category']}}</a>
                        </li> 
                        <!-- ============================================================== -->
                        <!-- create new -->
                        <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{route('push.logout')}}"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link-push waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span class="hide-menu">会員管理 </span></a>
                            <ul aria-expanded="false" class="">
                                <li class="sidebar-item"><a href="{{route('push.user.list_confirm')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 登録希望者の承認 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('push.user.list_refuse')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 却下一覧 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('push.user.import')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 会員番号リスト </span></a></li>
                                <li class="sidebar-item"><a href="{{route('push.users.create')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 新規アカウント作成 </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link-push waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span class="hide-menu">Push通知</span></a>
                            <ul aria-expanded="false" class="">
                                <li class="sidebar-item"><a href="{{route('push.notification.index')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> Push通知管理 </span></a></li>
                                <!-- <li class="sidebar-item"><a href="{{route('push.listmemberpushs.index')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 配信リスト管理 </span></a></li> -->
                        ...
                        <!-- <li class="sidebar-item"> <a class="sidebar-link-push waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span class="hide-menu">TVPro</span></a>
                            <ul aria-expanded="false" class="">
                                <li class="sidebar-item"><a href="{{route('push.videos.index')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> コンテンツ管理 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('push.analytic.content')}}" class="sidebar-link-push">&nbsp;&nbsp;&nbsp;&nbsp;<span class="hide-menu"> 視聴状況 </span></a></li>
