    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => 'rss.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group date">
                        <input type="text" name="date" class="form-control datetimepicker" id="datetimepicker" placeholder="date">
