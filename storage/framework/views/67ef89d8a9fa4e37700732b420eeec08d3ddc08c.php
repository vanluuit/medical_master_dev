            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => ['videos.update', $video->id], 'id'=>'validate', 'enctype'=>'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                       <?php echo Form::select('channel_id', $channels, $video->channel_id, ['placeholder' => 'チャンネル', 'class'=>'form-control select2']); ?>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <?php echo e(str_replace('storage/app/TVpro/videos/','',$video->video)); ?>
