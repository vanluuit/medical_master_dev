                      ...
                      <tbody>
                        ...
                        @foreach($userreviews as $key => $userreview)
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('push.user.list.review', ['id'=>$userreview->id])}}">Delete</a>
                            </td>
                          </tr>
                        @endforeach
                        @endif
