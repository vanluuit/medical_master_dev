      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                 {!! Form::select('category_id', $cate, $message->category_id, ['placeholder' => '学会選択', 'class'=>'form-control select2 filter_in', 'id'=>'category_id']) !!}
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                 {!! Form::select('channel_id', $channel, $message->channel_id, ['placeholder' => 'channel', 'class'=>'form-control select2', 'id'=>'channel_id']) !!}
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                 {!! Form::select('content_id', $videos,  $message->content_id, ['placeholder' => 'content', 'class'=>'form-control select2', 'id'=>'content_id']) !!}
              </div>
            </div>
            <div class="form-group row">
                      <div class="col-md-3">
