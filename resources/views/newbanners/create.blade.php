    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => 'newbanners.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('type', ['1'=>'Content', '2'=>'Url'], '', ['placeholder' => 'type', 'class'=>'form-control select2', 'id'=>'change_association_type']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                  ...
                  <!-- <div class="form-group row">
                    <div class="col-md-6">
                       {!! Form::select('location', $location_ar, '', ['placeholder' => 'location', 'class'=>'form-control select2']) !!}
                    </div>
                  </div>  -->
                  <div class="form-group row">
                    <div class="col-md-6">
