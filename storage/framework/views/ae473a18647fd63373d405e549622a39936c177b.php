      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                 <?php echo Form::select('category_id', $cate, '', ['placeholder' => '学会選択', 'class'=>'form-control select2 filter_in', 'id'=>'category_id']); ?>

              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                 <?php echo Form::select('channel_id', $channel, '', ['placeholder' => 'channel', 'class'=>'form-control select2', 'id'=>'channel_id']); ?>

              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-12">
                 <?php echo Form::select('content_id', $videos, '', ['placeholder' => 'content', 'class'=>'form-control select2', 'id'=>'content_id']); ?>
...
<?php $__env->startSection('script'); ?> 
    <script>
        ...
        $(document).on('change','#category_id', function(){
          ...
          $.ajax({url: "<?php echo e(route('channel.by.category')); ?>?category_id="+category_id, success: function(result){
        ...
        $(document).on('change','#channel_id', function(){
          ...
          // var category_new_id = $('#category_new_id').val();
          $.ajax({url: "<?php echo e(route('videos.by.channel')); ?>?channel_id="+channel_id, success: function(result){
            var ar = JSON.parse(result);
            // if(ar.length > 0){
              var str ='<option selected=\"selected\" value=\"\">Content</option>\"';
              for (var i = 0; i < ar.length; i++) {
                str = str+'<option value="'+ar[i].id+'">'+ar[i].title+'</option>'
              }
              $('#content_id').html(str);
