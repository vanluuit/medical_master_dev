...
<body>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <span id="report_total">{{count($reports)}}</span>
                            </a>
                             <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
                                @foreach($reports as $report)
                                    <a class="dropdown-item" href="{{route('discussion.comments_list')}}?id={{$report->id}}">{{$report->comment}}</a>
                                @endforeach
                            </div>
                        </li>
                        <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        {{-- <li class="nav-item dropdown show">
                            <a id="nofical" class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="mdi mdi-bell font-24"></i>
                            <span>10</span>
                            </a>
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">会員管理 </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('members.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">学会別会員番号リスト</span></a></li>
                                <li class="sidebar-item"><a href="{{route('users.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> 登録会員一覧 / 編集 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('pushusers.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> 登録会員一覧 / 編集 (push) </span></a></li>
                                <li class="sidebar-item"><a href="{{route('admin.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> Admin  </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('banners.index')}}" aria-expanded="false"><i class="mdi mdi-folder-image"></i><span class="hide-menu">Banner</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('prs.index')}}" aria-expanded="false"><i class="mdi mdi-folder-image"></i><span class="hide-menu">Pr</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">学会管理 </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('associations.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> 学会登録 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('rss.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> お知らせ／トピックス管理 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('topics.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> スケジュール登録 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('discussion.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> ディスカッション管理 </span></a></li>
                                <li class="sidebar-item"><a href="{{route('seminars.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> 学術集会抄録登録  </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-video"></i><span class="hide-menu">TVPro管理 </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('channels.index')}}?category_id=1" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">チャンネル</span></a></li>
                                <li class="sidebar-item"><a href="{{route('channels.index')}}/?except=1" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">公開予定リスト</span></a></li>
                                <li class="sidebar-item"><a href="{{route('videos.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> コンテンツ </span></a></li>
                                <!-- <li class="sidebar-item"><a href="{{route('questions.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> Questions </span></a></li> -->
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-new-box"></i><span class="hide-menu">News管理 </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('category_news.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> カテゴリ </span></a></li>
                                <li class="sidebar-item"><a href="{{route('news.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">News</span></a></li>
                                <li class="sidebar-item"><a href="{{route('newbanners.index')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Banner</span></a></li>
                            </ul>
                        </li>  
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-new-box"></i><span class="hide-menu">Messages Push </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('notification.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> global </span></a></li>
                               {{--  <li class="sidebar-item"><a href="{{route('news.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">News</span></a></li> --}}
                                {{-- <li class="sidebar-item"><a href="{{route('news.index')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">コメント</span></a></li> --}}
                            </ul>
                        </li>                        
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-sort-ascending"></i><span class="hide-menu">Analytics </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{route('analytic.channels')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">TVpro</span></a></li>
                                <li class="sidebar-item"><a href="{{route('analytic.news')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">News</span></a></li>
                                <li class="sidebar-item"><a href="{{route('analytic.banner')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu">Banner</span></a></li>
                                <!-- <li class="sidebar-item"><a href="{{route('videos.index')}}" class="sidebar-link"><i class="mdi mdi-arrow-right-box"></i><span class="hide-menu"> コンテンツ </span></a></li> -->
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('api_key')}}" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">API KEY</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('versions.index')}}" aria-expanded="false"><i class="mdi mdi-rotate-3d"></i><span class="hide-menu">Version</span></a></li>
                    </ul>
                </nav>
    ...
    <script src="{{ URL::asset('/assets/libs/jquery-validation/dist/jquery.validate.min.js')}}"></script>
