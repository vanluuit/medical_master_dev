            ...
            <div class="card-body">
                ...
                <div class="row">
	                <div class="col-md-6">
	                  ...
	                  <div class="form-group row">
	                    <div class="col-md-12">
	                       {!! Form::select('type', [1=>'Quick',2=>'TVpro',3=>'News',4=>'Mypage', '5'=>'Seminar'], '', ['placeholder' => 'select tab', 'class'=>'form-control select2']) !!}
	                    </div>
	                  </div>
	                  <div class="form-group row">
	                    <div class="col-md-12">
	                       {!! Form::select('category_id', $cate, '', ['placeholder' => '学会選択', 'class'=>'form-control select2 filter_in', 'id'=>'category_change']) !!}
	                    </div>
	                  </div>
	                  <div class="form-group row">
	                    <div class="col-md-3">
