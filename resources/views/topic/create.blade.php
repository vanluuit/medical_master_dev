    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                {!! Form::open(array('route' => 'topics.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group date">
                        <input type="text" name="start_date" class="form-control datepicker-autoclose" id="" placeholder="start date">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group date">
                        <input type="text" name="end_date" class="form-control datepicker-autoclose" id="" placeholder="end date">
                        <div class="input-group-append">
                          <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                        </div>
                      </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('building', '', ['placeholder' => 'building', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::text('map', '', ['placeholder' => 'map', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      {!! Form::text('url_text', '', ['placeholder' => 'URL text', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      {!! Form::textarea('unit', '', ['placeholder' => 'unit', 'class'=>'form-control']) !!}
                    </div>
                  </div>
                </div>
