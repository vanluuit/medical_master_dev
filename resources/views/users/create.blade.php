    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              {!! Form::open(array('route' => 'users.store', 'id'=>'validate', 'enctype'=>'multipart/form-data')) !!}
              <div class="card-body">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <label for="avatar"><img id="avatar_show" src="#" alt="" /></label>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                ...
                <div id="association">                
                  <div class="form-group row">
                    <div class="col-md-3">
                      {!! Form::select('association_id[]', $categories, '', ['placeholder' => '学会選択', 'class'=>'form-control association_select']) !!}
                    </div>
                    <div class="col-md-3">
                      {!! Form::select('member_code[]', [], '', ['placeholder' => '学会会員番号', 'class'=>'form-control member_code']) !!}
                    </div>
                    <div class="col-md-1">
